  ...
  if(type == "hogar"){
    df = expss::apply_labels(df,
                             ...
                             REGION = c("Gran Buenos Aires" = 1,
                                        ...
                                        "Pampeana" = 43,
                                        "Patagonica." = 44),
                             MAS_500 = 'Aglomerados segun tamano',
                             ...
                             IV2 = 'Cuantos ambientes/  habitaciones  tiene  la  vivienda en  total?  (sin  contar  bano/s,  cocina,  pasillo/s,lavadero, garage)',
                             ...
                             IV8 = 'Tiene bano/letrina?',
                             IV8 = c("Si" = 1,
                                     "No." = 2),
                             IV9 = 'El bano o letrina esta...',
                             IV9 = c("Si" = 1,
                                     "No." = 2),
                             IV10 =	'El bano tiene...',
                             ...
                             V18 = c("Si" = 1,
                                     "No." = 2),
                             V19_A =	'menores de  10  anos  ayudan  con  algun  dinero		trabajando?',
                             V19_A = c("Si" = 1,
                                       "No." = 2),
                             V19_B =	'Menores de  10  anos  ayudan  con  algun  dinero	pidiendo?',
                             V19_B = c("Si" = 1,
                                       "No." = 2),
                             IX_TOT =		'Cantidad de miembros del Hogar',
                             IX_MEN10 =		'Cantidad de miembros del Hogar menores de 10 anos',
                             IX_MAYEQ10 =		'Cantidad de miembros del Hogar de 10 y mas anos',
    ...
    df = expss::apply_labels(df,
                             ...
                             CH04 = c("Varon" = 1,
                                      "Mujer" = 2),
                             CH05 = 'Fecha de nacimiento (dia, mes y ano)',
                             CH06 = 'Edad en anos cumplidos',
                             ...
                             CH13 = c("Si" = 1,
                                      "No" = 2,
                                      "Ns/Nr." = 9),
                             CH14 = 'Cual fue el ultimo ano que aprobo?',
                             CH14 = c("Ninguno" = 0,
                                      "Primero" = 1,
                                      "Segundo" = 2,
                                      "Tercero" = 3,
                             ...
                             PP02E = c("esta suspendido" = 1,
                                       ...
                                       "hay poco trabajo en esta ?poca del ano" = 4,
                                       "por otras razones." = 5),
                             ...
                             PP04B3_ANO = 'Cuanto tiempo hace que trabaja alli? - AnO',
                             ...
                             PP04C = c("1 persona" = 1,
                                       ...
                                       "Ns./Nr." = 99),
                             PP04C99 = 'Tamano del establecimiento',
                             PP04C99 = c("hasta 5" = 1,
                                         "de 6 a 40" = 2,
                                         "mas de 40" = 3,
                                         "Ns./Nr.." = 9),
                             ...
                             PP05B2_ANO = 'Cuanto tiempo hace que trabaja en ese emPPleo en forma continua? - AnO',
                             ...
                             PP11B2_ANO = 'Cuanto tiempo trabajo alli? - AnOS',
                             ...
                             PP11G_ANO = 'Cuanto tiempo seguido estuvo trabajando en ese lugar? - AnO',
                             ...
                             V19_AM = 'Monto del ingreso por TRABAJO DE MENORES DE 10 AnOS.',
