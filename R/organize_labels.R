...
#'
#' @return Devuelve la base con sus variables etiquetadas de acuerdo con el disenio de registro de la EPH (no renombra los valores o nombres de las columnas, agrega etiquetas con esta información)
#'
#' @details
...
organize_labels <- function(df, type = "individual") {
  ...
  if (type == "hogar") {
    df <- suppressWarnings(expss::apply_labels(df,
      ...
      IV3 = c(
        "Mosaico/baldosa/madera/ceramica/alfombra" = 1,
      ...
      IV6 = "Tiene agua...",
      IV6 = c(
        "Por caneria dentro de la vivienda" = 1,
        "Fuera de la vivienda pero dentro del terreno" = 2,
        "Fuera del terreno." = 3
      ),
      IV7 = "El agua es de...",
      IV7 = c(
        "Red publica (agua corriente)" = 1,
      ...
      IV11 = c(
        "Inodoro  con  boton/  mochila/ cadena y  arrastre	de agua" = 1,
    ...
    df <- suppressWarnings(expss::apply_labels(df,
      ...
      PP03H = c(
        "podia trabajarlas esta semana" = 1,
      ...
      PP04G = c(
        "En un local / oficina / establecimiento / neogocio / taller / chacra / finca" = 1,
      ...
      PP11O = c(
        "Despido / cierre (quiebre/venta/traslado de la empresa/reestructuracion o recorte de personal/falta de ventas o clientes" = 1,
