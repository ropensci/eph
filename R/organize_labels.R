...
organize_labels <- function(df, type = "individual"){
  ...
  df = expss::apply_labels(df,
                          ...
                          REGION = c("Gran Buenos Aires" = 1,
                                     ...
                                     "Pampeana" = 43,
                                     "Patagonica." = 44),
                          MAS_500 = 'Aglomerados segun tama\u00f1o',
                          ...
                          IV2 = 'Cuantos ambientes/  habitaciones  tiene  la  vivienda en  total?  (sin  contar  ba\u00f1o/s,  cocina,  pasillo/s,lavadero, garage)',
                          ...
                          IV5 = c("Si" = 1,
                                  "No." = 2),
                          IV6 = 'Tiene agua...',
                          IV6 = c("Por ca\u00f1eria dentro de la vivienda" = 1,
                          ...
                          V18 = c("Si" = 1,
                                  "No." = 2),
                          V19_A =	'menores de  10  a\u00f1os  ayudan  con  algun  dinero		trabajando?',
                          V19_A = c("Si" = 1,
                                    "No." = 2),
                          V19_B =	'Menores de  10  a\u00f1os  ayudan  con  algun  dinero	pidiendo?',
                          V19_B = c("Si" = 1,
                                    "No." = 2),
                          IX_TOT =		'Cantidad de miembros del Hogar',
                          IX_MEN10 =		'Cantidad de miembros del Hogar menores de 10 a\u00f1os',
                          IX_MAYEQ10 =		'Cantidad de miembros del Hogar de 10 y mas a\u00f1os',
    ...
    df = expss::apply_labels(df,
                             ...
                             CH04 = c("Varon" = 1,
                                      "Mujer" = 2),
                             CH05 = 'Fecha de nacimiento (dia, mes y a\u00f1o)',
                             ...
                             CH13 = c("Si" = 1,
                                      "No" = 2,
                                      "Ns/Nr." = 9),
                             CH14 = 'Cual fue el ultimo a\u00f1o que aprobo?',
                             CH14 = c("Ninguno" = 0,
                                      "Primero" = 1,
                                      "Segundo" = 2,
                                      "Tercero" = 3,
                             ...
                             PP02C6 = c("Si" = 1,
                                        "No" = 2),
                             PP02C7 = 'De Que manera estuvo buscando trabajo? - Se anoto en bolsas, listas, planes de empleo, agencias, contratistas o alguien le estpa buscando trabajo',
                             PP02C7 = c("Si" = 1,
                                        "No" = 2),
                             ...
                             PP04B3_ANO = 'Cuanto tiempo hace que trabaja alli? - A\u00f1O',
                             ...
                             PP05B2_ANO = 'Cuanto tiempo hace que trabaja en ese emPPleo en forma continua? - A\u00f1O',
                             ...
                             PP11B2_ANO = 'Cuanto tiempo trabajo alli? - A\u00f1OS',
                             ...
                             PP11G_ANO = 'Cuanto tiempo seguido estuvo trabajando en ese lugar? - A\u00f1O',
                             ...
                             DECOCUR = 'N\u00ba de decil de ingreso de la ocupacion principal del TOTAL EPH.',
                             IDECOCUR = 'N\u00ba de decil de ingreso de la ocupacion principal del INTERIOR EPH',
                             RDECOCUR = 'N\u00ba de decil de ingreso de la ocupacion principal de la REGION',
                             GDECOCUR = 'N\u00ba de decil de ingreso de la ocupacion principal del CONJUNTO DE AGLOMERADOS DE 500 MIL Y MAS HABITANTES',
                             PDECOCUR = 'N\u00ba de decil de ingreso de la ocupacion principal del CONJUNTO DE AGLOMERADOS DE MENOS DE 500 MIL HABITANTES',
                             ADECOCUR = 'N\u00ba de decil de ingreso de la ocupacion principal del AGLOMERADO.',
                             ...
                             DECCFR = 'N\u00ba de decil de ingreso per capita familiar del TOTAL EPH (ver Anexo I).',
                             IDECCFR = 'N\u00ba de decil de ingreso per capita familiar del  INTERIOR EPH (ver Anexo I).',
                             RDECCFR = 'N\u00ba de decil de ingreso per capita familiar de la REGION.',
                             GDECCFR = 'N\u00ba de decil de ingreso per capita familiar del CONJUNTO DE AGLOMERADOS DE 500 MIL Y MAS HABITANTES.',
                             PDECCFR = 'N\u00ba de decil de ingreso per capita familiar del CONJUNTO DE AGLOMERADOS DE MENOS DE 500 MIL HABITANTES.',
                             ADECCFR = 'N\u00ba de decil de ingreso per capita familiar del AGLOMERADO.',
