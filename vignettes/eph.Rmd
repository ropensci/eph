...
- `period`: un valor numérico entero con el trimestre (en caso de que se trate de la EPH continua, 2004-actualidad) o la onda (EPH puntual)
...
base_2018t1 <- get_microdata(year = 2018,  period = 1,  type = 'individual', 
                       vars = variables) 

### Descargo la base individual para el 2018_t2
base_2018t2 <- get_microdata(year = 2018,  period = 2,  type = 'individual', 
                       vars = variables) 
