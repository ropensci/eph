...
rama_caes <- function(variable = rama) {
  rama.caes <- case_when(
    ...
    (variable %in% c(
      "01", "0101", "0102", "0103", "0104", "0105",
      "02", "0200", "03", "0300"
    )) ~ "A",
    ## B --> Explotación de minas y canteras.
    (variable %in% c(
      "05", "0500", "500", "06", "0600", "07", "0700", "08",
      "0800", "09", "0900"
    )) ~ "B",
    ## C --> Industria Manufacturera.
    (variable %in% c(
      "10", "1001", "1002", "1003", "1009", "11", "1100", "12",
      ...
      "3003", "3009", "31", "3100", "32", "3200", "33", "3300"
    )) ~ "C",
    ...
    (variable %in% c(
      "45", "4501", "4502", "4503", "4504", "48", "4801", "4802",
      "4803", "4804", "4805", "4806", "4807", "4808",
      "4809", "4810", "4811"
    )) ~ "G",
    ## H --> Transporte y almacenamiento.
    (variable %in% c(
      "49", "4901", "4902", "4903", "4904", "4905", "4909", "50",
      "5000", "51", "5100", "52", "5201", "5202", "53", "5300"
    )) ~ "H",
    ## I --> Alojamiento y servicios de comidas.
    (variable %in% c("55", "5500", "56", "5601", "5602")) ~ "I",
    ## J --> Información y comunicación.
    (variable %in% c(
      "58", "5800", "59", "5900", "60", "6000", "61", "6100",
      "62", "6200", "63", "6300"
    )) ~ "J",
    ...
    (variable %in% c(
      "69", "6900", "70", "7000", "71", "7100", "72", "7200", "73",
      "7301", "7302", "74", "7400", "75", "7500"
    )) ~ "M",
    ## N --> Actividades administrativas y servicios de apoyo.
    (variable %in% c(
      "77", "7701", "7702", "78", "7800", "79", "7900", "80", "8000",
      "81", "8101", "8102", "82", "8200"
    )) ~ "N",
    ...
    (variable %in% c(
      "94", "9401", "9402", "9409", "95", "9501", "9502", "9503",
      "96", "9601", "9602", "9603", "9606", "9609"
    )) ~ "S",
...
caes <- caes %>%
  ...
  mutate(
    caes_eph_cod = rama_caes_eph(caes_seccion_cod),
